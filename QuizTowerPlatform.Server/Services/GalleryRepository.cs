...
namespace QuizTowerPlatform.Server.Services;

public class GalleryRepository(ApiDbContext galleryContext) : IGalleryRepository
{
    private readonly ApiDbContext _context = galleryContext ??
